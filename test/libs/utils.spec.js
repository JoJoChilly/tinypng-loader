    ...
    describe('string2Uint8array', () => {
        it('parameter(s) <hello> should derive return <null>', () => {
            ...
            chai_configuration_1
                .expect(JSON.stringify(utils_1.string2Uint8array(input)))
                .to.equals('{"0":104,"1":101,"2":108,"3":108,"4":111}'); // [104, 101, 108, 108, 111]
        });
        ...
        it('parameter(s) <0> should derive return <null>', () => {
            const input = 0;
            chai_configuration_1
                .expect(() => utils_1.string2Uint8array(input))
                .to.throw(`utils: unknown parameter type. expect parameter type to be string`);
        });
        ...
        it('parameter(s) <[]> should derive to throw', () => {
            ...
            chai_configuration_1
                .expect(() => utils_1.string2Uint8array(input))
                .to.be.throw(`utils: unknown parameter type. expect parameter type to be string`);
        });
